...
import { View, Text, StyleSheet, ViewPagerAndroidComponent, KeyboardAvoidingView, Platform } from 'react-native';
    ...
    <KeyboardAvoidingView
      ...
      keyboardVerticalOffset={80}>
        <Text style={styles.text}> 
          ...
          A sua privacidade é importante para nós. É política do App Deliver respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site App Deliver, e outros sites que possuímos e operamos.
          ...
          Política de Cookies App Deliver
          O que são cookies?
          ...
          O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o App Deliver oferece no site e com caráter enunciativo, mas não limitativo:

          A) Não se envolver em atividades que sejam ilegais ou contrárias à boa fé a à ordem pública;
          B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, ou sobre cassinos, apostas online (ex.: Betano), jogos de sorte e azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;
          C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do App Deliver, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.
        </Text>
